    ...
    def __iter__(self, random=False):
        ...
        for is_end, d in self.sample(random):
            ...
            if spoes:
                ...
                subject_ids = (start[0], end[0])
                # 对应的object标签
                object_labels = np.zeros((len(token_ids), num_labels, 2))
...
def loss_function(subject_labels, subject_preds, object_labels, object_preds):
...
total_loss = loss_function(subject_labels, subject_preds, object_labels, object_preds)
